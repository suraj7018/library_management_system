...
public:
	void bookDetailsEntry()
	{
		...
		fobj << " " << bookid << "      " << bname << "      " << book_author << endl;
		fobj.close();
	...
	label_search:
		...
		case 1:
			char str_line[1000];
			char str_line1[1000];
			if (fobj1.getline(str_line1, 1000))
			{
				cout << "\n\n================================================================================";
				
				cout << "\n\n" << str_line1;

				while (fobj1.getline(str_line, 1000))
				{
					cout << "\n\n" << str_line;
				}
				cout << "\n\n================================================================================\n\n";
		...
		case 2:
			char str_line2[1000], str_line5[1000];
			cout << "\nEnter book name : ";
			char bookname[10];
			cin.ignore();
			cin.getline(bookname, 50);
			if (fobj1.getline(str_line2, 1000))
			{
				fobj1.seekg(0, ios::beg);
				int s = 1;
				cout << "\n\n================================================================================";
				while (fobj1.getline(str_line2, 1000))
				{
	...
	void delete_book()
	{
		...
		char temp_search[500], temp_search1[1000];
		cin.ignore();
		cin.getline(temp_search, 1000);
		
		if (fin.getline(temp_search1, 1000))
		{
			fin.seekg(0, ios::beg);
			char q;
			...
			if (q == 'Y' | q == 'y')
			{
				...
				while (fin.getline(temp_str, 1000))
				{
